...
2、直接上传
    ...
    void testUpload() throws FileNotFoundException {
        ...
        ossClient.putObject("gmall-wan", "spring cloud alibaba全解2.pdf", inputStream);
...
#如果这个dev不放开的话，默认的gmall-coupon不生效【会加载dev分组下的所有配置】
...
gmall-admin数据库：renren-fast的数据库中，有新建菜单的数据
...
逆向生成代码目录：gmall-product\main\resources\src\views\modules\product
...
#### * 创建gmall-third-party模块

在gmall-third-party模块中封装oss的policy请求
...
```properties
1、创建gmall-third-party模块作为第三方服务模块
...
spring.application.name=gmall-third-party
spring.cloud.nacos.config.server-addr=127.0.0.1:8848
spring.cloud.nacos.config.namespace=93331e33-77bb-4ea0-958f-216afa8b9fb0
spring.cloud.nacos.config.group=dev
#如果这个dev不放开的话，默认的gmall-third-party不生效【会加载dev分组下的所有配置】
...
4、设置跨域，允许bucket跨域请求
	在oss里面修改管理控制台修改：
	https://oss.console.aliyun.com/bucket/oss-cn-shanghai/gmall-wan/permission/cors
```
...
6、创建统一异常处理类
在product微服务下创建exception.gmallExceptionControllerAdvice.java
...
1、拷贝1-分布式基础_全栈开发篇\代码\sql\sys_menus.sql内部的内容
	打开gmall-admin数据库【就是renren-fast的数据库】，执行该sql代码
...
```json
{
	...
	"weight": 0.196,
	"publishStatus": 0,
	"decript": ["https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/bebfdd56-8672-480f-8ba3-1da068a6eb59_73366cc235d68202.jpg", "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/1006bd68-bfb9-4849-8861-4d5621843cbf_528211b97272d88a.jpg"],
	"images": ["https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/d6923575-f61a-4ee1-8596-cef5e490882c_0d40c24b264aa511.jpg", "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/70be7094-b654-4e95-8be6-ba153b87d87a_1f15cdbcf9e1273c.jpg", "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/e1c08d80-a580-43b6-842b-b62c0f73806f_3c24f9cd69534030.jpg", "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/21bc10f1-2668-4b1e-841a-54ad64624c10_8bf441260bffa42f.jpg", "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/39b2613e-e411-4046-8a2c-e40225fb90c3_28f296629cca865e.jpg", "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/76978c17-9bed-4b40-8ccd-c87b3bcaae26_335b2c690e43a8f8.jpg", "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/5a500297-8984-469b-8af2-90c35835260f_d511faab82abb34b.jpg", "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/ff6d6732-13b0-4d0a-81f9-f321d3cf43fd_919c850652e98031.jpg", "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/52dc8b33-bb64-4026-831c-81eab8e9bdd3_73ab4d2e818d2211.jpg", "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/2565d892-a915-4589-868a-54e0a02f5afc_a83bf5250e14caf2.jpg", "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/15f0de72-1cbe-47bf-849c-591a4a398a1c_23d9fbb256ea5d4a.jpg", "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/41cb75e5-be0c-41bf-8937-99c8c1bc45a9_b5c6b23d01dcdf81.jpg"],
	"bounds": {
		"buyBounds": 500,
		"growBounds": 500
	},
	...
	"skus": [{
		...
		"images": [{
			"imgUrl": "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/d6923575-f61a-4ee1-8596-cef5e490882c_0d40c24b264aa511.jpg",
			"defaultImg": 1
		}, {
			"imgUrl": "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/70be7094-b654-4e95-8be6-ba153b87d87a_1f15cdbcf9e1273c.jpg",
			"defaultImg": 0
		}, {
			"imgUrl": "",
			"defaultImg": 0
			...
			"imgUrl": "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/5a500297-8984-469b-8af2-90c35835260f_d511faab82abb34b.jpg",
			"defaultImg": 0
		}, {
			"imgUrl": "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/ff6d6732-13b0-4d0a-81f9-f321d3cf43fd_919c850652e98031.jpg",
			"defaultImg": 0
		}, {
			"imgUrl": "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/52dc8b33-bb64-4026-831c-81eab8e9bdd3_73ab4d2e818d2211.jpg",
			"defaultImg": 0
		}, {
			"imgUrl": "",
			"defaultImg": 0
		...
		"images": [{
			...
			"imgUrl": "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/21bc10f1-2668-4b1e-841a-54ad64624c10_8bf441260bffa42f.jpg",
			"defaultImg": 1
		}, {
			"imgUrl": "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/39b2613e-e411-4046-8a2c-e40225fb90c3_28f296629cca865e.jpg",
			"defaultImg": 0
		}, {
			"imgUrl": "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/76978c17-9bed-4b40-8ccd-c87b3bcaae26_335b2c690e43a8f8.jpg",
			"defaultImg": 0
		}, {
			"imgUrl": "",
			"defaultImg": 0
		...
		"images": [{
			...
			"imgUrl": "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/2565d892-a915-4589-868a-54e0a02f5afc_a83bf5250e14caf2.jpg",
			"defaultImg": 1
		}, {
			"imgUrl": "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/15f0de72-1cbe-47bf-849c-591a4a398a1c_23d9fbb256ea5d4a.jpg",
			"defaultImg": 0
		}, {
			"imgUrl": "https://gmall-wan.oss-cn-shanghai.aliyuncs.com/2020-08-12/41cb75e5-be0c-41bf-8937-99c8c1bc45a9_b5c6b23d01dcdf81.jpg",
			"defaultImg": 0
		}],
...
响应数据
{
	...
	"page": {
		...
		"list": [{
			...
			"catalogId": 225,
			"brandId": 9,
			"skuDefaultImg": "https://gmall-hello.oss-cn-beijing.aliyuncs.com/2019-11-26/60e65a44-f943-4ed5-87c8-8cf90f403018_d511faab82abb34b.jpg",
